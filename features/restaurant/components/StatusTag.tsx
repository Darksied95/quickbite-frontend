...
export const StatusTag = ({ status, className }: { status: ValidStatus | "new", className?: string }) => {
    return (
        <p className={cn(" py-1 px-2 w-fit rounded-xl text-xs font-medium capitalize",
            {
                ...
                "text-blue-700 bg-blue-200": status === "preparing" || status === "picked up",
                " text-gray-500 bg-gray-200": status === "received" || status === "new",
